#!/usr/bin/env bash
# Module 5 · Spikee — goat (multi-turn) (starter)
#
# Runs spikee's 'goat' attack against Larkfield. YOU write the objective: edit seeds-starter/standalone_user_inputs.jsonl with a Module 3 threat.
...
#
#   bash <course>/modules/module5/spikee/goat/starter.sh
#
set -euo pipefail
...
PYV
spikee generate --seed-folder "$SEEDS" --format user-input --include-standalone-inputs --tag m5goats
DS=$(ls -t datasets/*m5goats*.jsonl | head -1)
