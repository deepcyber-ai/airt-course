#!/usr/bin/env bash
# Module 5 · Spikee — goat (multi-turn) (complete)
#
# Runs spikee's 'goat' attack against Larkfield. objective = cross-customer PII (same as every method).
...
#   bash <course>/modules/module5/spikee/goat/complete.sh
#
set -euo pipefail
