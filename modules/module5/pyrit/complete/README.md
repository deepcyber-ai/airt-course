...
python3 modules/module5/pyrit/complete/attack.py --stage single
python3 modules/module5/pyrit/complete/attack.py --stage crescendo
python3 modules/module5/pyrit/complete/attack.py --stage goat
python3 modules/module5/pyrit/complete/attack.py --stage headtohead
```
...
python3 modules/module5/pyrit/complete/attack.py --stage tap
