...
a multi-turn agent that reasons Observation→Thought→Strategy→Next-Message each turn. Promptfoo's hosted service GENERATES THE ATTACK TURNS; only grading may use your
...
strategy  : goat  (hosted generation)
